...
def run_scenarios() -> dict[str, object]:
    scenarios = {
        "A_stable_30m": recommend_action(4.0, 0.12, 0.18, 30, 30, 60).__dict__,
        "B_long_falling_input": recommend_action(2.2, 0.78, 0.72, 150, 150, 260).__dict__,
        "C_after_break": recommend_action(3.5, 0.22, 0.16, 18, 18, 120).__dict__,
        "D_high_switch_tolerant": recommend_action(3.3, 0.38, 0.25, 55, 55, 150).__dict__,
    }
    expected = {
