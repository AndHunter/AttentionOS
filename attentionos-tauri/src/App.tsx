...
type MlDiagnostics = { last_inference_at?: string | null; model_version?: string | null; policy_source?: string | null; candidate_utilities: Record<string, number>; diagnostics: Record<string, unknown> }
