...
const ru = {
  ...
  actions: { exportData: '\u042d\u043a\u0441\u043f\u043e\u0440\u0442 \u0434\u0430\u043d\u043d\u044b\u0445', deleteTelemetry: '\u0423\u0434\u0430\u043b\u0438\u0442\u044c \u0442\u0435\u043b\u0435\u043c\u0435\u0442\u0440\u0438\u044e', deleteReports: '\u0423\u0434\u0430\u043b\u0438\u0442\u044c \u043e\u0442\u0447\u0451\u0442\u044b', deleteInterventions: '\u0423\u0434\u0430\u043b\u0438\u0442\u044c \u0440\u0435\u043a\u043e\u043c\u0435\u043d\u0434\u0430\u0446\u0438\u0438', deleteModel: '\u0423\u0434\u0430\u043b\u0438\u0442\u044c \u043c\u043e\u0434\u0435\u043b\u044c', deleteAll: '\u0423\u0434\u0430\u043b\u0438\u0442\u044c \u0432\u0441\u0451 \u043b\u043e\u043a\u0430\u043b\u044c\u043d\u043e', add: '\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c' },
...
const en = {
  ...
  actions: { exportData: 'Export data', deleteTelemetry: 'Delete telemetry', deleteReports: 'Delete self reports', deleteInterventions: 'Delete interventions', deleteModel: 'Delete model', deleteAll: 'Delete all local data', add: 'Add' },
...
function App() {
  ...
  useEffect(() => {
    ...
    }, Math.max((settings?.notifications.live_check_interval_seconds ?? 60) * 1000, 30000))
    return () => window.clearInterval(timer)
...
function SettingsModal({ dashboard, settings, unreadCount, ui, onClose, onSave }: { dashboard: DashboardPayload | null; settings: RuntimeSettings; unreadCount: number; ui: UiText; onClose: () => void; onSave: (settings: RuntimeSettings) => Promise<void> }) {
...
function localizeNotificationTitle(value: string, language: 'en' | 'ru') { if (language !== 'ru') return value; return value === 'Time for a break' ? '\u041f\u043e\u0440\u0430 \u043d\u0430 \u043f\u0435\u0440\u0435\u0440\u044b\u0432' : value }
